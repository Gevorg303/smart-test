            ...
            try {
                ...
                switch (type) {
                    case "test":
                        ...
                        const response2 = await fetch('http://localhost:8081/test/get-user-tests', {
                            method: 'POST',
                            headers: {
                    ...
                    case "task":
                        ...
                        const response3 = await fetch('http://localhost:8081/task/get-user-tasks', {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json;charset=UTF-8'
                            },
                    ...
                    case "subject":
                        ...
                        const response4 = await fetch('http://localhost:8081/subject/print-user-subject', {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json;charset=UTF-8'
                            },
                    ...
                    case "theme":
                        ...
                        const response5 = await fetch('http://localhost:8081/theme/get-theme-by-id-user', {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json;charset=UTF-8'
                            },
                    ...
                    case "indicator":
                        ...
                        const response6 = await fetch('http://localhost:8081/indicator/indicator-by-user', {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json;charset=UTF-8'
                            },
                    ...
                    case "class":
                        ...
                        const response8 = await fetch('http://localhost:8081/users/find-student-class-by-user', {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json;charset=UTF-8'
                            },
